...
date: "2021/01/09 (updated: `r Sys.Date()`)"
output:
...
## Um diplomata deve aprender a programar?
...
# Quais as vantagens de um diplomata aprender a programar?
...
- Setor político: análise de dados eleitorais;
...
.center[![more](https://media4.giphy.com/media/l0Exdm9UbTHAFcJi0/giphy.gif)]

---
class: center, middle, inverse

## As oportunidades a quem sabe programar são proporcionais à falta de modernização do Itamaraty
...
Os livros em R são de altíssima qualidade.
